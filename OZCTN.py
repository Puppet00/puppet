########################################################################################################################################################
## pip install cloudscraper && pip install undetected-chromedriver && pip install PyVirtualDisplay && pip install xvfbwrapper && pip install colorama ##
########################################################################################################################################################
# -*- coding: utf-8 -*-
...
def title():
    ...
    stdout.write("                                                                                          \n")
    stdout.write("                           "+Fore.LIGHTWHITE_EX+"@OZCTN\n")
    stdout.write("                                                                                          \n")
...
def hello():
    ...
    if os.path.exists(dir):
        ...
        put = input()
        f = open("C:/OZCTN/User.txt", 'w').write(put)
        namee = open(dir+"User.txt").readline()
